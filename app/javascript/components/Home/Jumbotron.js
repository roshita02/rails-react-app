                ...
                <div className="row">
                    <div className="col col-sm-12 col-md-5">
                        <div className="pt-4 mt-4">
                            <Header>React on rails developers</Header>
                            <Subhead>Learn react on rails by developing a simple course site.</Subhead>
                            <div className="cta-wrapper">
                                <Button className="btn fancy-btn">Get started</Button>
                            </div>
                        </div>
                    </div>
                    <div className="col col-sm-12 col-md-7"></div>
